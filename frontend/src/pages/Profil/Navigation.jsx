                ...
                <div className="flex justify-between items-center w-full">
                    ...
                    <div className="hidden xl:block xl:w-1/3">
                        <div className="flex items-center justify-end">
                            ...
                            <a className="inline-block py-2 px-4 text-sm leading-5 text-green-50 bg-green-500 hover:bg-green-600 font-medium focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md" href="#">
                                Sign Up
                            </a>
                        </div>
                    </div>
                </div>
                <button onClick={() => setOpenNav(!openNav)} className="navbar-burger self-center xl:hidden">
            ...
            {openNav && (
                <div className="navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50">
                    <div className="fixed top-0 left-0 bottom-0 w-full w-4/6 max-w-xs bg-white">
                            ...
                            <div className="flex flex-col justify-between h-full">
                                ...
                                <div className="flex flex-wrap">
                                    <div className="w-full mb-2">
                                        <a className="inline-block py-2 px-4 w-full text-sm leading-5 text-coolGray-500 hover:text-coolGray-900 bg-transparent font-medium text-center rounded-md" href="#">
                                            Log In
                                        </a>
                                    </div>
                        ...
                        <button onClick={() => setOpenNav(false)} className="navbar-close absolute top-5 p-4 right-3">
